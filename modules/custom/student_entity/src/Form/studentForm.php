...
class studentForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($status == SAVED_UPDATED) {
      drupal_set_message($this->t('The Student %feed has been updated.', ['%feed' => $entity->toLink()->toString()]));
    } else {
      drupal_set_message($this->t('The Student %feed has been added.', ['%feed' => $entity->toLink()->toString()]));
    }
